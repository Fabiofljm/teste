            ...
            children: [
              ...
              Container(
                ...
                child: ToggleSwitch(
                  ...
                  minHeight: 50,
                  cornerRadius: 20.0,
                  activeBgColors: const [[Colors.yellow], [Colors.red]],
                  activeFgColor: Colors.white,
                  inactiveBgColor: Colors.grey[400],
                  inactiveFgColor: Colors.white,
                  initialLabelIndex: 0,
                  totalSwitches: 2,
                  customTextStyles: const [ TextStyle(color: Colors.black, fontSize: 16, fontWeight: FontWeight.bold, fontStyle: FontStyle.italic) ],
                  labels: const ['Conectado', 'Desconectado'],
                  radiusStyle: true,
                  onToggle: (index) {
